...
def htmlize(segment,s):
    ...
    content += '  <tr><th>gf</th><th>id</th><th>pos</th><th>is</th><th>msd</th><th>p</th></tr>\n'
    for a in j['a']:
        content += '  <tr>\n'
        content += '   <td>' + utf8.e(a['gf']) + '</td>\n'
        content += '   <td>' + saldo_util.lid_ref(utf8.e(a['id'])) + '</td>\n'
    ...
    html = saldo_util.html_document(segment,content,service='ff')
    return html
